...
<p align="center">
  <h3>huntercat: The Ultimate Web Reconnaissance & Vulnerability Scanner 🚀</h3>
</p>

<p align="center"><a href="https://github.com/yogeshojha/huntercat/releases" target="_blank"><img src="https://img.shields.io/badge/version-v2.2.0-informational?&logo=none" alt="huntercat Latest Version" /></a>&nbsp;<a href="https://www.gnu.org/licenses/gpl-3.0" target="_blank"><img src="https://img.shields.io/badge/License-GPLv3-red.svg?&logo=none" alt="License" /></a>&nbsp;<a href="#" target="_blank"><img src="https://img.shields.io/badge/first--timers--only-friendly-blue.svg?&logo=none" alt="" /></a></p>
...
<p align="center">
<a href="https://github.com/yogeshojha/huntercat/actions/workflows/codeql-analysis.yml" target="_blank"><img src="https://github.com/yogeshojha/huntercat/actions/workflows/codeql-analysis.yml/badge.svg" alt="" /></a>&nbsp;<a href="https://github.com/yogeshojha/huntercat/actions/workflows/build.yml" target="_blank"><img src="https://github.com/yogeshojha/huntercat/actions/workflows/build.yml/badge.svg" alt="" /></a>&nbsp;
</p>
...
<h4>huntercat 2.2.0 is released!</h4>
<p>
  huntercat 2.2.0 comes with bounty hub where you can sync and import your hackerone programs, in app notifications, chaos as subdomain enumeration tool, ability to upload multiple nuclei and gf patterns, support for regex in out of scope subdomain config, additional pdf report template and many more. 
  <b>Check out <a href="https://huntercat.wiki/whats-new/2_2_0/">What's new in huntercat 2.2.0!</a></b>
</p>
...
[Watch huntercat 2.0-jasper release trailer here!](https://youtu.be/VwkOWqiWW5g)

![-----------------------------------------------------](https://raw.githubusercontent.com/andreasbm/readme/master/assets/lines/aqua.png)

## Documentation

Detailed documentation available at [https://huntercat.wiki](https://huntercat.wiki) 
...
* [What's new in huntercat](https://github.com/yogeshojha/huntercat/releases)
...
🧭&nbsp;&nbsp;Continuous monitoring: Continuous monitoring is at the core of huntercat's mission, and it's robust continuous monitoring feature ensures that their targets are under constant scrutiny. With the flexibility to schedule scans at regular intervals, penetration testers can effortlessly stay informed about their targets. What sets huntercat apart is its seamless integration with popular notification channels such as Discord, Slack, and Telegram, delivering real-time alerts for newly discovered subdomains, vulnerabilities, or any changes in reconnaissance data.
...
<img src="https://github.com/yogeshojha/huntercat/assets/17223002/10c475b8-b4a8-440d-9126-77fe2038a386">
...
<p align="center">
  <a href="https://hailbytes.com/hardened-ubuntu-huntercat/" target="_blank">
    <img src="https://hailbytes.com/wp-content/uploads/2020/04/HailBytes-Logo-2023-350-%C3%97-100-px.png" alt="HailBytes - Enterprise huntercat Support" height="60"/>
  </a>
</p>

<p align="center">
  Official enterprise-grade support, deployment, and maintenance services for huntercat are available through <a href="https://hailbytes.com">HailBytes</a>.
</p>

<p align="center">
You can also find the deep dive video on how to use and install huntercat from here <a href="https://www.youtube.com/watch?v=C6BFBxLmZIA">huntercat Deep Dive by HailBytes</a>
</p>
...
1. Clone the repository
    ...
    ```bash
    git clone https://github.com/yogeshojha/huntercat && cd huntercat
    ```
...
For Mac, Windows, or other systems, refer to our detailed installation guide [https://huntercat.wiki/install/detailed/](https://huntercat.wiki/install/detailed/)
...
Please note: This is community-curated content and is not owned by huntercat. The installation process may change, so please refer to the official documentation for the most up-to-date instructions.
...
huntercat has a vibrant community that often creates helpful content about installation, features, and usage. Below is a collection of community-curated videos that you might find useful. Please note that these videos are not official huntercat content, and the information they contain may become outdated as huntercat evolves.
...
|-------------|----------|----------|------|------|
| huntercat Installation on Kali Linux | English | Secure the Cyber World | 2024-02-29 | [Watch](https://www.youtube.com/watch?v=7OFfrU6VrWw) |
...
| huntercat Introduction | Moroccan Arabic | Th3 Hacker News Bdarija | 2021-07-27 | [Watch](https://www.youtube.com/watch?v=9FuRrcmWgWU) |
...
To get started:
  ...
  2. Pick an [open issue](https://github.com/yogeshojha/huntercat/issues) or propose a new one
...
* Check our [open issues](https://github.com/yogeshojha/huntercat/issues) for starter-friendly tasks
...
* Please carefully read the README and documentation at [huntercat.wiki](https://huntercat.wiki).
...
Your support, whether through donations or simply giving a star, tells me that huntercat is valuable to you. It motivates me to continue improving and adding features to make huntercat the go-to tool for reconnaissance.
